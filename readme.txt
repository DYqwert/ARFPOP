...
For example, I put 100 sample sequence files in the folder /home/Projectdir/and set k value to 4, filtering minimum kmer copy number to 0, and set CPU number to 10.
Just run the code:

sh ARFPOP.sh /home/ProjectDir 4 KNCDir 0 100 10
